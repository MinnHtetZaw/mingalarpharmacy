...
@section('content')
        <div class="row">
            ...
            @elseif(request()->is('searchIncomeHistory'))

                <a href="{{ route('incomes') }}" class="btn btn-info ml-3">Back</a>
        ...
        <div class="row justify-content-start">
            <div class="col-8">
               <div class="mb-4">
                <form action="{{ route('search_income_history')}}" method="POST" >
                    @csrf
                    <div class="row">

                        <div class="col-2">
                            <label class="">@lang('lang.from')</label>
                            <input type="date" name="from" id="from" class="form-control form-control-sm"  required>
                        </div>
                        <div class="col-2">
                            <label class="">@lang('lang.to')</label>
                            <input type="date" name="to" id="to" class="form-control form-control-sm"  required>
                        </div>
                 ...
                 <form id="exportForm" onsubmit="return exportForm()" method="get">
                    @csrf
                     <div class="row">
                        ...
                        @if(request()->is('searchIncomeHistory'))
