    ...
    <div class="row">
        ...
        <div class="form-group row">
            ...
            <form id="exportForm" onsubmit="return exportForm()" method="get">
               ...
               <input type="hidden" name="export_from" id="pexport_from" class="form-control form-control-sm hidden" required>
               <input type="hidden" name="export_to" id="pexport_to" class="form-control form-control-sm hidden" required>

               <div class="ml-2 mt-1" style="width: 30%">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group form-focus select-focus">
                            <label class="focus-label pinkcolor">From Date</label>
                                <input class="form-control floating" type="date" id="fromdate"  onChange="setFrom(this.value)">
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group form-focus select-focus">
                            <label class="focus-label pinkcolor">To Date</label>
                                <input class="form-control floating" type="date" id="todate"  onChange="setTo(this.value)">
                        </div>
                    </div>
                        <div class="col-sm-6 col-md-3">
                            <button class="btn bpinkcolor text-white btn-block" onclick="searchPatient('all')">Search Patient</button>
...
@section('js')
    ...
    <script>
        ...
        console.log(from,to);
         ...
         let url = `/patientlistexport/${from}/${to}`;
