        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label text-black">Select Expire Range</label>
                            <select class="form-control select2" id="expire_status">
                            ...
                            @foreach($items as $item)
                                ...
                                @endphp
                                        <tr>
                                            ...
                                            <td class="text-center">{{$unit->expired_date ? $unit->expired_date :'-'}}</td>
                                        </tr>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#expire_status").select2({
            placeholder:"သက်တမ်းကုန်ဆုံး ရှာရန်",
        });
    });
    ...
    function checkUnit(){
        ...
        let expire_range =$('#expire_status').val();
        ...
        $.ajax({
            ...
            url:'{{route('AjaxGetCountingUnit_by_ExpireStatus')}}',
                ...
                $.each(data , function(i, value) {
                    ...
                    $.each(value.stockcount,function(k,stock){
                        if(stock.from_id==shop_id && stock.stock_qty<= value.reorder_quantity){
                            ...
                            $('#units_table').append($('<tr>')).append($('<td>').text(value.item.category.category_name)).append($('<td>').text(value.item.item_name)).append($('<td>').text(value.unit_name)).append($('<td>').append(stockcountt)).append($('<td>').append(value.reorder_quantity)).append($('<td>').append(value.expired_date));
                        }
                    })
